...
from src.diffusion.resample import UniformSampler
from src.diffusion import space_timesteps
...
from src.diffusion.base import GenerativeType, LossType, ModelMeanType, ModelVarType, get_named_beta_schedule
from model import *
from choices import *
...
data_paths = {
    'ffhqlmdb256':
    os.path.expanduser(Path(project_root) / 'datasets' / 'ffhq256.lmdb'),
    # used for training a classifier
    'celeba':
    os.path.expanduser(Path(project_root) / 'datasets' / 'celeba'),
    # used for training DPM models
    'celebalmdb':
    os.path.expanduser(Path(project_root) / 'datasets' / 'celeba.lmdb'),
    'celebahq':
    os.path.expanduser(Path(project_root) / 'datasets' / 'celebahq256.lmdb'),
    'horse256':
    os.path.expanduser(Path(project_root) / 'datasets' / 'horse256.lmdb'),
    'bedroom256':
    os.path.expanduser(Path(project_root) / 'datasets' / 'bedroom256.lmdb'),
    'celeba_anno':
    os.path.expanduser(Path(project_root) / 'datasets' / 'celeba_anno/list_attr_celeba.txt'),
    'celebahq_anno':
    os.path.expanduser(
        Path(project_root) / 'datasets' / 'celeba_anno/CelebAMask-HQ-attribute-anno.txt'),
    'celeba_relight':
    os.path.expanduser(Path(project_root) / 'datasets' / 'celeba_hq_light/celeba_light.txt'),
}
