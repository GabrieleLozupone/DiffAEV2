...
if __name__ == "__main__":
    ...
    default_input_imgs_path = Path(project_root) / 'examples' / 'imgs'
    default_output_imgs_path = Path(project_root) / 'examples' / 'imgs_align'

    parser = ArgumentParser()
    parser.add_argument("-i",
                        "--input_imgs_path",
                        type=str,
                        default=default_input_imgs_path,
                        help="input images directory path")
    parser.add_argument("-o",
                        "--output_imgs_path",
                        type=str,
                        default=default_output_imgs_path,
